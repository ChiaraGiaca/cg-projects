...
./bin/yraytrace tests/13_refract/refract.json -o out/lowres/13_refract.jpg -s 256 -b 8 -r 720
./bin/yraytrace tests/snow/snow.json -o out/lowres/snow_shader.jpg -s 256 -t personal -r 720
./bin/yraytrace tests/02_matte/matte.json -o out/lowres/toon_shader.jpg -s 9 -t toon -r 720